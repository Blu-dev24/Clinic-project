  ...
  const services = [
    {
      ...
      desc: "Lorem ipsum, dolor sit amet consectetur adipisicing elit. Corrupti ex consectetur officiis repellat, optio temporibus, ducimus",
      link: "#facelift",
    },
    {
        ...
        <div className="container mx-auto px-4 mt-0 pt-0">
          ...
          >
            {services.map((service, index) => (
              <li key={index}>
                <article className="bg-white rounded-xl p-8 hover:shadow-lg transition-all duration-300 hover:-translate-y-1 h-full flex flex-col">
